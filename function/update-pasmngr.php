...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (password_verify($oldpassword, $currentPassword)) {
        ...
        header("Location: ../manager-update.php?jpid=$jpid&success=Password Updated Successful");
        exit;
    } else {
        // Old password does not match
        header("Location: ../manager-update.php?jpid=$jpid&error=Invalid Old Password");
        exit;
    }
}
