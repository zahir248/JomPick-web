...
$userlocation = $_SESSION["jp_location_id"];
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" id="fprof" name="fprof"  action="function/update-profile.php" enctype="multipart/form-data">
                            <div class="card-body">
                            <?php
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" id="fpass" name="fpass" action="function/update-password.php" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
