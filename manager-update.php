...
$page = 'manager-update.php'; 
$screen_name = 'Manager Update';
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-4 text-gray-800">Manager Profile</h1>
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" action="function/update-manager.php?jpid=<?php echo $jpid;?>" enctype="multipart/form-data" onsubmit="return validateForm()">
                            <div class="card-body">
                                <?php
                                ...
                                $role_id = $row['role_id'];
                                $image = $row['image'];
                                $userlocation = $row['jp_location_id'];
                                ...
                                $sql2 = "SELECT name FROM pickup_location WHERE pickupLocation_id = $userlocation;"; 
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class = "form-control" id="managers" name="managers" value="<?php echo $mgrStaff; ?>" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
                                            <label for="locations">Location Incharge: </label>
                                            <input type="text" class="form-control" id="locations" name="locations" value="<?php echo $address; ?>" required readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-footer py-3" >
                                <div class="row">
                                    <div class="col-xl-6 col-md-6">
                                        <div class="small text-white"><a href="manager-list.php" class="btn btn-primary btn-sm">Back</a></div>
                                    </div>
                                    <div class="col-xl-6 col-md-6">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" id="fpass" name="fpass" action="function/update-pasmngr.php?jpid=<?php echo $jpid;?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
