...
$page = 'staff-update.php'; 
$screen_name = 'Staff Update';
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-4 text-gray-800">Staff Profile</h1>
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" action="function/update-staff.php?jpid=<?php echo $jpid;?>" enctype="multipart/form-data" onsubmit="return validateForm()">
                            <div class="card-body">
                                <?php
                            ...
                            <div class="card-footer py-3" >
                                <div class="row">
                                    <div class="col-xl-6 col-md-6">
                                        <div class="small text-white"><a href="staff-list.php" class="btn btn-primary btn-sm">Back</a></div>
                                    </div>
                                    <div class="col-xl-6 col-md-6">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" id="fpass" name="fpass" action="function/update-passtaf.php?jpid=<?php echo $jpid;?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
